...
function CarriageInwardreturnform({ FormData, setFormData }: any) {
  let ProductArr: any = [];
    ...
    <div className='supermaincontain'>
      <div className="formcontainer" >
        ...
        <Form.Group className="mb-3 mt-3" controlId="formGridQuantity">
          ...
          <Form.Control type='number' placeholder="Quantity" name='inwardReturnQty' value={FormData.inwardReturnQty} onChange={InputChange} />
        </Form.Group>
...
export default CarriageInwardreturnform;